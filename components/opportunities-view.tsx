...
export function OpportunitiesView({ isOpen, onClose }: OpportunitiesViewProps) {
        ...
        <Card className="m-6 rounded-lg border-0 shadow-lg">
          <CardHeader>
            <div className="flex items-center justify-between">
              <CardTitle>Opportunities Dashboard</CardTitle>
                ...
                <div className="grid gap-8 lg:grid-cols-2">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="space-y-2 max-h-96 overflow-y-auto">
                      {serviceLineOpportunities.map((line, idx) => (
                        <button
                          key={line.name}
                        ...
                        >
                          ...
                          <div className="relative h-6 w-full rounded-sm overflow-hidden bg-muted/20 border border-border/50">
                            <div
                              ...
                              style={{
                                backgroundColor: [barColors.mint, barColors.peach, barColors.lavender, barColors.orange, barColors.green][idx % 5],
                                width: `${(line.value / 194.35) * 100}%`,
                              }}
                            />
                          </div>
                        </button>
